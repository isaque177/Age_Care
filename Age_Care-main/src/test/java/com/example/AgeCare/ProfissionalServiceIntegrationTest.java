...
class ProfissionalServiceIntegrationTest {
 ...
 private ProfissionalModel criarProfissionalFake() {
    ...
    profissional.setFormacao("Fisioterapia"); // valor fixo agora
    ...
    void testListarProfissionais() {
        ...
        boolean existeEnfermagem = lista.stream()
                                        .anyMatch(p -> "Enfermagem".equals(p.getFormacao()));
        assertTrue(existeEnfermagem, "[ASSERT] Deve conter um profissional de Enfermagem");
