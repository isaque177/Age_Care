...
MODIFY tipo_usuario ENUM('cuidador', 'responsavel') NULL;
...
CREATE TABLE usuarios (
    ...
    nome, email, senha_hash, telefone, celular, tipo_usuario, 
    foto_perfil, data_nascimento, cpf, ativo, verificado
) VALUES (
    'Maria da Silva',
    'maria.silva@example.com',
    '$2a$10$7N9e2wW1gRFXYQd3GtFQWuFq9/zFPeQY9xxbOESmMhx3l.DvnXz7e', -- exemplo de hash bcrypt
    '1122334455',
    '11999998888',
    'cuidador',
    'https://exemplo.com/perfil/maria.jpg',
    '1985-06-15',
    '123.456.789-00',
    TRUE,
    FALSE
...
CREATE TABLE profissionais (
    ...
    raio_atendimento_km DECIMAL (10,2),
    biografia TEXT,
...
INSERT INTO profissionais (
    ...
    1,
    1, -- deve existir na tabela 'usuarios'
    5,
    'Graduação em Enfermagem pela Universidade Federal de São Paulo',
    'Cuidados paliativos, Alzheimer, Pós-operatório',
    80.00,
    500.00,
    TRUE,
    30.0,
    'Profissional dedicada com experiência em atendimentos domiciliares.',
    'https://exemplo.com/curriculos/maria_cv.pdf',
    4.75,
    20,
    50,
    'aprovado'
